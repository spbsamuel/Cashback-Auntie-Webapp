...
import {cardUserCardId, totalCardExpenditure, totalCashback, hashExpensesWithCashback, cashbackCalculator} from 'selectors/cards/cimb_visa_signature_cashback'
...
const mapStateToProps = (state) => {
  return ({
    ...
    cashbackCalculator: cashbackCalculator(state)
  })
};
